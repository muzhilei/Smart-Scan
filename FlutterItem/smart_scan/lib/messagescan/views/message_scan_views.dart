...
class message_scan_views extends GetView<message_scan_controllers>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(S.of(context).homeMessage,style: TextStyle(fontSize: 20,color: Colors.white),),
        centerTitle: true,
      ),
      body: Column(
        children: [
              ...
              children: [
                Expanded(
                  child: TextField(
                    ...
                    maxLines: 1,
                    onChanged: controller.setEditePhone,
                  ),
                ),
              ],
            ),
